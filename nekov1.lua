...
ShowMessage("Silly Scripts"," By Gazer_HA", 10)
ShowMessage("fe neko", "Originally made by? Who?", 10)
...
RunService.Heartbeat:Connect(function()
	...
	RealChar.HumanoidRootPart.Velocity = Vector3.new(1, 1, 1) 
	RealChar.HumanoidRootPart.RotVelocity = Vector3.new(1, 1, 1) 
	end)
end)
...
-- hey go die
-- also if you steal my taunts and dont credit me for them i'll fucking find you and ban you
...
local lastid= "http://www.roblox.com/asset/?id=1840684529"
...
local function GatherAllInstances(Parent,ig)
	local Instances = {}
	local Ignore=nil
if	ig ~= nil then
Ignore = ig	
...
local function JointAllTo(Part1,Part2,scan,Extra)
local EXCF = Part2.CFrame * Extra	
for i, v3 in pairs(scan:GetDescendants()) do
	if v3:isA("BasePart") then	
...
local function AddStoneTexture(part)
	coroutine.resume(coroutine.create(function()
	for i = 0,6,1 do
...
local function CreatePart2(FORMFACTOR, PARENT, MATERIAL, REFLECTANCE, TRANSPARENCY, BRICKCOLOR, NAME, SIZE, ANCHOR)
...
if CurId == 1 then
lastid= "http://www.roblox.com/asset/?id=1840684529 "
elseif CurId == 2 then
lastid= "http://www.roblox.com/asset/?id=1848354536"
elseif CurId == 3 then
lastid= "http://www.roblox.com/asset/?id=9045766377"
elseif CurId == 4 then
lastid= "http://www.roblox.com/asset/?id=9047105533"
elseif CurId == 5 then
lastid= "http://www.roblox.com/asset/?id=1841979451"
elseif CurId == 6 then
lastid= "http://www.roblox.com/asset/?id=1837768517"
...
ImageButton1.Size = UDim2.new(0, 50, 0, 50)  -- Small size (50x50 pixels)
ImageButton1.Position = UDim2.new(1, -60, 0.1, 0)  -- Positioned near the top, not too high
ImageButton1.AnchorPoint = Vector2.new(1, 0)  -- Anchor to the top-right corner of the button
ImageButton1.Image = "rbxassetid://12159177184"  -- First image ID
ImageButton1.BackgroundTransparency = 1  -- Make the background transparent

-- Set properties for the second ImageButton
ImageButton2.Parent = ScreenGui
ImageButton2.Size = UDim2.new(0, 50, 0, 50)  -- Small size (50x50 pixels)
ImageButton2.Position = UDim2.new(1, -60, 0.3, 0)  -- Positioned below the first button
ImageButton2.AnchorPoint = Vector2.new(1, 0)  -- Anchor to the top-right corner of the button
ImageButton2.Image = "rbxassetid://14139670222"  -- Second image ID
ImageButton2.BackgroundTransparency = 1  -- Make the background transparent

-- Function to simulate pressing the "N" key for the first button
...
local function simulateKeyPress2()
    local VirtualInputManager = game:GetService("VirtualInputManager")
...
-- Connect the click event to the first button
ImageButton1.MouseButton1Click:Connect(simulateKeyPress1)
